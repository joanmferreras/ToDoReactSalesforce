...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _todoModel = __webpack_require__(159);

	var _todoModel2 = _interopRequireDefault(_todoModel);

	var _todoApp = __webpack_require__(161);
	...
	(function () {
		...
		function render() {
			_react2["default"].render(_react2["default"].createElement(_todoApp2["default"], { model: model }), document.getElementsByClassName('todoapp')[0]);
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TodoModel = function TodoModel(key) {
	  this.key = key;
	  this.todos = _utils2["default"].store(key);
	  this.onChanges = [];
	};
	...
	TodoModel.prototype.inform = function () {
	  _utils2["default"].store(this.key, this.todos);
	...
	TodoModel.prototype.toggleAll = function (checked) {
	  ...
	  this.todos = this.todos.map(function (todo) {
	    return _utils2["default"].extend({}, todo, { completed: checked });
	  });
	...
	TodoModel.prototype.toggle = function (todoToToggle) {
	  this.todos = this.todos.map(function (todo) {
	    return todo !== todoToToggle ? todo : _utils2["default"].extend({}, todo, { completed: !todo.completed });
	  });
	...
	TodoModel.prototype.save = function (todoToSave, text) {
	  this.todos = this.todos.map(function (todo) {
	    return todo !== todoToSave ? todo : _utils2["default"].extend({}, todo, { title: text });
	  });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _director = __webpack_require__(162);
	...
	var TodoApp = (function (_React$Component) {
	  ...
	  _createClass(TodoApp, [{
	    key: "createNewTodo",
	    value: function createNewTodo(val) {
	      var promise, result;
	      return regeneratorRuntime.async(function createNewTodo$(context$2$0) {
	        while (1) switch (context$2$0.prev = context$2$0.next) {
	          case 0:
	            promise = remoteInsertToDoPromise(val);
	            context$2$0.next = 3;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TodoFooter = _react2["default"].createClass({
	  ...
	  render: function render() {
	    var activeTodoWord = _utils2["default"].pluralize(this.props.count, 'item');
